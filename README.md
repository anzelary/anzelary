### About me
----
Analytical Data Analyst with 15+ years’ experience in finance operations across the UK and Latvia, specialising in reconciliations, AP/AR, VAT, invoicing, and financial reporting. AAT Level 4 qualified Finance Officer with a strong foundation in accounting, data accuracy, and financial control. Currently developing advanced data analytics skills in `Python`, `SQL`, `Power BI`, `Tableau`, and data modelling, complemented by strong `Excel` expertise (`Pivot Tables`, `Power Query`). 
...
<!--
**anzelary/anzelary** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
